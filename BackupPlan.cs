...
public sealed class BackupPlanEntry
{
    ...
    {
        BackupPlanEntryKind.CopyToTarget => "Copy -> Target",
        BackupPlanEntryKind.CopyToSource => "Copy -> Source",
        BackupPlanEntryKind.DeleteFileFromTarget => "Delete file in target",
        BackupPlanEntryKind.DeleteFileFromSource => "Delete file in source",
        BackupPlanEntryKind.DeleteDirectoryFromTarget => "Delete folder in target",
        BackupPlanEntryKind.DeleteDirectoryFromSource => "Delete folder in source",
        _ => Kind.ToString()
    };
